          ...
          children: <Widget>[
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                  backgroundColor: Color.fromARGB(255, 80, 200, 78)),
            ),
            SizedBox(
              height: 20,
            ),
            ElevatedButton(
              ...
              child: Text('SUBTRACT'),
              style: ElevatedButton.styleFrom(
                  backgroundColor: Color.fromARGB(255, 71, 185, 54)),
            ),
            SizedBox(
              height: 20,
            ),
            ElevatedButton(
              ...
              child: Text('MULTIPLY'),
              style: ElevatedButton.styleFrom(
                  backgroundColor: Color.fromARGB(255, 62, 214, 64)),
            ),
            SizedBox(
              height: 20,
            ),
            ElevatedButton(
              ...
              child: Text('DIVIDE'),
              style: ElevatedButton.styleFrom(
                  backgroundColor: Color.fromARGB(255, 78, 215, 119)),
            )
          ],
        ),
      ),
